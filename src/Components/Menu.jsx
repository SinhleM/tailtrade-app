...
import { Filter, X, ChevronDown, ChevronUp, AlertTriangle, ShoppingBag, Heart } from 'lucide-react'; // Added Heart
...
const Menu = () => {
  ...
  const [expandedSections, setExpandedSections] = useState({
    ...
    price: true,
    location: true,
    favoritesFilterSection: true // Added for the new favorites filter
  });
  ...
  useEffect(() => {
    ...
    if (showFavoritesFilter) params.set('showFavorites', 'true'); // Add showFavorites to URL params
  ...
  const processedListings = useMemo(() => {
    ...
    // Apply "Show Favorites" filter first if active
                ...
                {processedListings.length === 0 ? (
                  <div className="flex flex-col justify-center items-center h-80 border border-gray-200 rounded-lg bg-gray-50 p-8 text-center shadow">
                    ...
                    <button
                      onClick={() => {
                        ...
                        setSortBy('newest');
                        setShowFavoritesFilter(false); // Reset favorites filter
                      }}
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
                    {processedListings.map(listing => (
                      ...
                      >
                        <div 
                          className="h-40 sm:h-56 bg-gray-100 relative overflow-hidden cursor-pointer"
